...
async function getRulesContent() {
  try {
    ...
    return configs.find((c: any) => c.key === "page_rules")?.value || "<p>Contenido no disponible.</p>";
  } catch (err) {
    return "<p>Error cargando reglas oficiales.</p>";
  }
}
    ...
    <div className="min-h-[70vh] bg-brand-blue pt-16 pb-24">
      <div className="container mx-auto px-6 max-w-3xl">
        <h1 className="text-4xl md:text-6xl font-black text-white uppercase italic tracking-tighter mb-12 drop-shadow-[0_0_15px_rgba(255,222,0,0.2)]">
          Reglas <span className="text-brand-yellow">Oficiales</span>
        </h1>
