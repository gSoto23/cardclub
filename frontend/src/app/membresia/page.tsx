...
async function getMembershipContent() {
  try {
    ...
    return configs.find((c: any) => c.key === "page_membership")?.value || "<p>Próximamente información sobre nuestras membresías.</p>";
  } catch (err) {
    return "<p>Error cargando información de membresía.</p>";
  }
}
