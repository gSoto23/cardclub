    ...
    <div className="min-h-screen bg-brand-blue">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Tarjeta de Códigos Promocionales */}
          <div onClick={() => window.location.href = '/admin/promo-codes'} className="bg-white/5 border border-white/10 p-6 rounded-xl hover:border-brand-yellow/30 transition-colors cursor-pointer group">
            <h3 className="text-white/60 text-sm font-bold uppercase tracking-widest mb-2">Descuentos</h3>
            <p className="text-3xl font-black text-white group-hover:text-brand-yellow transition-colors">Códigos</p>
            <p className="text-white/40 text-xs mt-4">Crear y gestionar cupones de descuento</p>
          </div>
